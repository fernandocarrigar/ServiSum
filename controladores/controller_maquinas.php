...
class Maquinas extends Conectar {
    private $table;
    private $view;
    private $id;
    private $lastid;
    ...
    public function insertMaquinaria($name,$file,$type) {
    ...
    public function updateMaquinaria($value,$name,$file,$type)  {
    ...
    public function deleteMaquinaria($value)  {
        $this->id = $value;
