...
if ((!empty($_GET['actioncon'])) && (isset($_GET['actioncon']))) {
    ...
    if ($action === 'insert') {
        ...
        echo '<script>location.replace("index.php?paga=EdicionContacto&ins=Ok");</script>';
    ...
    $telefono = "" . $_POST['Telefono'] . "";
        ...
        echo '<script>location.replace("index.php?page=EdicionContacto&upd=Ok&IdC='. $IdC .'");</script>';
            
    } elseif ($action === 'delete') {
        $contacto->deleteContacto($IdC);
        echo '<script>location.replace("index.php?page=EdicionContacto&del=Ok");</script>';
    }
}
