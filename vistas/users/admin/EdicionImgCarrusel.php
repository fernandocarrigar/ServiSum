...
<!-- Titulo de la vista -->
    ...
    if((!empty($dtpubwhere)) && (isset($dtpubwhere))){
        ?>
            <form method="post" action="index.php?page=EdicionImgCarrusel&actionpub=update&Id=<?php echo $Id ?>" enctype="multipart/form-data">
        <?php
    }else{
        ?>
            <form method="post" action="index.php?page=EdicionImgCarrusel&actionfile=insert&actionpub=insert" enctype="multipart/form-data">
        <?php
    }
