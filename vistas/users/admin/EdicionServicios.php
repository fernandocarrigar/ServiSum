...
<div class="container p-5 justify-content-center bg-dark-subtle">
    ...
    if ((!empty($dtserviciowhere)) && (isset($dtserviciowhere))) {
        ?>
        <form method="post" action="index.php?page=ServiciosAdmin&actionserv=update&IdS=<?php echo $IdS ?>"
            ...
            ?>
                    <div class="container-sm justify-content-center rounded-1 ms-auto me-auto p-2 bg-white">
                        <div class="form-floating m-3">
                            <input id="Servicio" name="Servicio" class="form-control" value="<?php echo $rows['Servicio'] ?>"
                                type="text" placeholder="Titulo del servicio" />
                            <label for="Servicio">Titulo del servicio</label>
                        </div>
                        <div class="form-floating m-3">
                            <textarea id="Descripcion" name="Descripcion" class="form-control"
                                value="<?php echo $rows['Descripcion'] ?>" type="text" placeholder="Descripcion" style="height:300px;"><?php echo $rows['Descripcion'] ?></textarea>
