...
<div class="container p-5 justify-content-center bg-dark-subtle">
    ...
    ?>
        <form method="post" action="index.php?page=EdicionEvidencias&actionevi=update&IdE=<?php echo $IdE ?>" enctype="multipart/form-data">
        <?php
    } else {
        ?>
            ...
            if (isset($dteviwhere)) {
                ...
                ?>
                    <div class="container-sm justify-content-center rounded-1 ms-auto me-auto p-2 bg-white">
                        ...
                        <div class="form-floating m-3">
                            <input id="Descripcion" name="Descripcion" class="form-control" value="<?php echo $rows['Descripcion'] ?>" type="text" placeholder="Descripcion del producto" onload="valSel('Descipcion','IdServicio')" required />
                            <label for="Descripcion">Descripcion corta de la evidencia</label>
                        </div>
                        <div class="form-floating m-3">
                            <select id="IdServicio" name="IdServicio" class="form-select" value="<?php echo $rows['IdServicio'] ?>" type="text" placeholder="Servicio al que pertenece" required>
                ...
                <div class="container-sm justify-content-center rounded-1 ms-auto me-auto p-2 bg-white">
                    ...
                    <div class="form-floating m-3">
                        <input id="Descripcion" name="Descripcion" class="form-control" type="text" placeholder="Descripcion del producto" required />
                        <label for="Descripcion">Descripcion corta de la evidencia</label>
                    </div>
                    <div class="form-floating m-3">
                        <select id="IdServicio" name="IdServicio" class="form-select" type="text" placeholder="Servicio al que pertenece" required>
                            <option selected disabled hidden>Seleccione un servicio</option>
                            <?php
                            foreach ($dtservicio as $rowserv) :
                            ?>
