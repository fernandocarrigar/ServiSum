...
<div class="container p-5 justify-content-center bg-dark-subtle">
    ...
    ?>
        <form method="post" action="index.php?page=EdicionPagina&actionpub=update&Id=<?php echo $Id ?>&Seccion=<?php echo $Seccion ?>" enctype="multipart/form-data">
        <?php
    } else {
        ?>
            <form method="post" action="index.php?page=EdicionPagina&actionfile=insert&actionpub=insert" enctype="multipart/form-data">
                <?php
            }
