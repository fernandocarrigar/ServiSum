...
<title>SSP - Editar Maquinaria</title>
...
<div class="container p-5 justify-content-center bg-dark-subtle">
    ...
    ?>
        <form method="post" action="index.php?page=EdicionMaquinaria&actionmaq=update&IdQ=<?php echo $IdQ ?>" enctype="multipart/form-data">
        <?php
    } else {
        ?>
            ...
            if (isset($dtmaquinawhere)) {
                ...
                ?>
                    <div class="container-sm justify-content-center rounded-1 ms-auto me-auto p-2 bg-white">
                        ...
                        <div class="form form-group m-3">
                            ...
                            <input id="Archivo" name="Archivo" class="form-control form-control-lg" type="file" placeholder="Inserte el logo del cliente" onchange="myimg()" />
                ...
                <div class="container-sm justify-content-center rounded-1 ms-auto me-auto p-2 bg-white">
                    ...
                    <div class="form form-group m-3">
                        <label for="Archivo" class="form-label">Imagen de la maquinaria:</label>
                        <input id="Archivo" name="Archivo" class="form-control form-control-lg" type="file" placeholder="Inserte el logo del cliente" onchange="myimg()" required />
                        <span class="text-muted">(Imagen de la maquinaria)</span>
                    </div>
                    <div class="form-floating m-3">
