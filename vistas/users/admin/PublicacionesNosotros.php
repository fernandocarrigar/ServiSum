                            ...
                            <div class="card-body overflow-auto shadow">
                                ...
                                <div class="d-inline-flex">
                                    ...
                                    if ($rows["Seccion"] === "Mision") {
                                        ?>
                                        <a href="index.php?page=EdicionMision&Id=<?php echo $rows['IdPublic'] ?>&form=<?php echo $Seccion ?>"
                                            class="btn btn-success btn-sm">
                                            Actualizar
                                        </a>
                                    <?php } elseif ($rows["Seccion"] === "Vision") { ?>
                                        <a href="index.php?page=EdicionVision&Id=<?php echo $rows['IdPublic'] ?>&form=<?php echo $Seccion ?>"
                                            class="btn btn-success btn-sm">
                                            Actualizar
                                        </a>
                                    <?php } elseif ($rows["Seccion"] === "Valores") { ?>
                                        <a href="index.php?page=EdicionValores&Id=<?php echo $rows['IdPublic'] ?>&form=<?php echo $Seccion ?>"
                                            class="btn btn-success btn-sm">
                                            Actualizar
                                        </a>
                                    <?php } ?>
                                ...
                                <div class="d-inline-flex">
                                    <a href="index.php?page=PublicacionesNosotros&Id=<?php echo $rows['IdPublic'] ?>&actionpub=delete&Seccion=<?php echo $Seccion ?>"
